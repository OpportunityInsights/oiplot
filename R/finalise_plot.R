...
#' Arrange alignment and save oi ggplot chart
#'
#' Running this function will save your plot with the correct guidelines for publication for a oi News graphic.
#' It will left align your title, subtitle and source, add the oi blocks at the bottom right and save it to your specified location.
...
#'  which needs to be a PNG file - defaults to oi blocks image that sits within the data folder of your package
